...
}`;function W2(n,e,t){let r=new uh;const i=new $e,o=new $e,s=new _t,a=new aw({depthPacking:aM}),l=new lw,c={},u=t.maxTextureSize,d={[Ni]:yn,[yn]:Ni,[wr]:wr},f=new Fi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $e},radius:{value:4}},vertexShader:G2,fragmentShader:$2}),h=f.clone();h.defines.HORIZONTAL_PASS=1;const _=new ui;_.setAttribute("position",new Pr(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const m=new Zn(_,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=R_;let p=this.type;this.render=function(R,A,P){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||R.length===0)return;const y=n.getRenderTarget(),M=n.getActiveCubeFace(),D=n.getActiveMipmapLevel(),O=n.state;O.setBlending(Di),O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const U=p!==Xr&&this.type===Xr,Y=p===Xr&&this.type!==Xr;for(let J=0,V=R.length;J<V;J++){const G=R[J],z=G.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",G,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const fe=z.getFrameExtents();if(i.multiply(fe),o.copy(z.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(o.x=Math.floor(u/fe.x),i.x=o.x*fe.x,z.mapSize.x=o.x),i.y>u&&(o.y=Math.floor(u/fe.y),i.y=o.y*fe.y,z.mapSize.y=o.y)),z.map===null||U===!0||Y===!0){const _e=this.type!==Xr?{minFilter:mr,magFilter:mr}:{};z.map!==null&&z.map.dispose(),z.map=new Co(i.x,i.y,_e),z.map.texture.name=G.name+".shadowMap",z.camera.updateProjectionMatrix()}n.setRenderTarget(z.map),n.clear();const he=z.getViewportCount();for(let _e=0;_e<he;_e++){const Me=z.getViewport(_e);s.set(o.x*Me.x,o.y*Me.y,o.x*Me.z,o.y*Me.w),O.viewport(s),z.updateMatrices(G,_e),r=z.getFrustum(),b(A,P,z.camera,G,this.type)}z.isPointLightShadow!==!0&&this.type===Xr&&x(z,P),z.needsUpdate=!1}p=this.type,g.needsUpdate=!1,n.setRenderTarget(y,M,D)};function x(R,A){const P=e.update(m);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,h.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,h.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Co(i.x,i.y)),f.uniforms.shadow_pass.value=R.map.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,n.setRenderTarget(R.mapPass),n.clear(),n.renderBufferDirect(A,null,P,f,m,null),h.uniforms.shadow_pass.value=R.mapPass.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,n.setRenderTarget(R.map),n.clear(),n.renderBufferDirect(A,null,P,h,m,null)}function v(R,A,P,y){let M=null;const D=P.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(D!==void 0)M=D;else if(M=P.isPointLight===!0?l:a,n.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const O=M.uuid,U=A.uuid;let Y=c[O];Y===void 0&&(Y={},c[O]=Y);let J=Y[U];J===void 0&&(J=M.clone(),Y[U]=J,A.addEventListener("dispose",E)),M=J}if(M.visible=A.visible,M.wireframe=A.wireframe,y===Xr?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:d[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,P.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const O=n.properties.get(M);O.light=P}return M}function b(R,A,P,y,M){if(R.visible===!1)return;if(R.layers.test(A.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&M===Xr)&&(!R.frustumCulled||r.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,R.matrixWorld);const U=e.update(R),Y=R.material;if(Array.isArray(Y)){const J=U.groups;for(let V=0,G=J.length;V<G;V++){const z=J[V],fe=Y[z.materialIndex];if(fe&&fe.visible){const he=v(R,fe,y,M);R.onBeforeShadow(n,R,A,P,U,he,z),n.renderBufferDirect(P,null,U,he,R,z),R.onAfterShadow(n,R,A,P,U,he,z)}}}else if(Y.visible){const J=v(R,Y,y,M);R.onBeforeShadow(n,R,A,P,U,J,null),n.renderBufferDirect(P,null,U,J,R,null),R.onAfterShadow(n,R,A,P,U,J,null)}}const O=R.children;for(let U=0,Y=O.length;U<Y;U++)b(O[U],A,P,y,M)}function E(R){R.target.removeEventListener("dispose",E);for(const P in c){const y=c[P],M=R.target.uuid;M in y&&(y[M].dispose(),delete y[M])}}}const X2={[xd]:Sd,[Md]:Ed,[wd]:Td,[As]:Cd,[Sd]:xd,[Ed]:Md,[Td]:wd,[Cd]:As};function j2(n,e){function t(){let F=!1;const we=new _t;let ie=null;const le=new _t(0,0,0,0);return{setMask:function(Te){ie!==Te&&!F&&(n.colorMask(Te,Te,Te,Te),ie=Te)},setLocked:function(Te){F=Te},setClear:function(Te,Ee,Xe,Dt,Qt){Qt===!0&&(Te*=Dt,Ee*=Dt,Xe*=Dt),we.set(Te,Ee,Xe,Dt),le.equals(we)===!1&&(n.clearColor(Te,Ee,Xe,Dt),le.copy(we))},reset:function(){F=!1,ie=null,le.set(-1,0,0,0)}}}function r(){let F=!1,we=!1,ie=null,le=null,Te=null;return{setReversed:function(Ee){if(we!==Ee){const Xe=e.get("EXT_clip_control");we?Xe.clipControlEXT(Xe.LOWER_LEFT_EXT,Xe.ZERO_TO_ONE_EXT):Xe.clipControlEXT(Xe.LOWER_LEFT_EXT,Xe.NEGATIVE_ONE_TO_ONE_EXT);const Dt=Te;Te=null,this.setClear(Dt)}we=Ee},getReversed:function(){return we},setTest:function(Ee){Ee?N(n.DEPTH_TEST):se(n.DEPTH_TEST)},setMask:function(Ee){ie!==Ee&&!F&&(n.depthMask(Ee),ie=Ee)},setFunc:function(Ee){if(we&&(Ee=X2[Ee]),le!==Ee){switch(Ee){case xd:n.depthFunc(n.NEVER);break;case Sd:n.depthFunc(n.ALWAYS);break;case Md:n.depthFunc(n.LESS);break;case As:n.depthFunc(n.LEQUAL);break;case wd:n.depthFunc(n.EQUAL);break;case Cd:n.depthFunc(n.GEQUAL);break;case Ed:n.depthFunc(n.GREATER);break;case Td:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}le=Ee}},setLocked:function(Ee){F=Ee},setClear:function(Ee){Te!==Ee&&(we&&(Ee=1-Ee),n.clearDepth(Ee),Te=Ee)},reset:function(){F=!1,ie=null,le=null,Te=null,we=!1}}}function i(){let F=!1,we=null,ie=null,le=null,Te=null,Ee=null,Xe=null,Dt=null,Qt=null;return{setTest:function(ft){F||(ft?N(n.STENCIL_TEST):se(n.STENCIL_TEST))},setMask:function(ft){we!==ft&&!F&&(n.stencilMask(ft),we=ft)},setFunc:function(ft,nr,Ur){(ie!==ft||le!==nr||Te!==Ur)&&(n.stencilFunc(ft,nr,Ur),ie=ft,le=nr,Te=Ur)},setOp:function(ft,nr,Ur){(Ee!==ft||Xe!==nr||Dt!==Ur)&&(n.stencilOp(ft,nr,Ur),Ee=ft,Xe=nr,Dt=Ur)},setLocked:function(ft){F=ft},setClear:function(ft){Qt!==ft&&(n.clearStencil(ft),Qt=ft)},reset:function(){F=!1,we=null,ie=null,le=null,Te=null,Ee=null,Xe=null,Dt=null,Qt=null}}}const o=new t,s=new r,a=new i,l=new WeakMap,c=new WeakMap;let u={},d={},f=new WeakMap,h=[],_=null,m=!1,g=null,p=null,x=null,v=null,b=null,E=null,R=null,A=new tt(0,0,0),P=0,y=!1,M=null,D=null,O=null,U=null,Y=null;const J=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,G=0;const z=n.getParameter(n.VERSION);z.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(z)[1]),V=G>=1):z.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),V=G>=2);let fe=null,he={};const _e=n.getParameter(n.SCISSOR_BOX),Me=n.getParameter(n.VIEWPORT),Fe=new _t().fromArray(_e),Q=new _t().fromArray(Me);function de(F,we,ie,le){const Te=new Uint8Array(4),Ee=n.createTexture();n.bindTexture(F,Ee),n.texParameteri(F,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(F,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Xe=0;Xe<ie;Xe++)F===n.TEXTURE_3D||F===n.TEXTURE_2D_ARRAY?n.texImage3D(we,0,n.RGBA,1,1,le,0,n.RGBA,n.UNSIGNED_BYTE,Te):n.texImage2D(we+Xe,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Te);return Ee}const ve={};ve[n.TEXTURE_2D]=de(n.TEXTURE_2D,n.TEXTURE_2D,1),ve[n.TEXTURE_CUBE_MAP]=de(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ve[n.TEXTURE_2D_ARRAY]=de(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ve[n.TEXTURE_3D]=de(n.TEXTURE_3D,n.TEXTURE_3D,1,1),o.setClear(0,0,0,1),s.setClear(1),a.setClear(0),N(n.DEPTH_TEST),s.setFunc(As),K(!1),q(Xp),N(n.CULL_FACE),w(Di);function N(F){u[F]!==!0&&(n.enable(F),u[F]=!0)}function se(F){u[F]!==!1&&(n.disable(F),u[F]=!1)}function oe(F,we){return d[F]!==we?(n.bindFramebuffer(F,we),d[F]=we,F===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=we),F===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=we),!0):!1}function ue(F,we){let ie=h,le=!1;if(F){ie=f.get(we),ie===void 0&&(ie=[],f.set(we,ie));const Te=F.textures;if(ie.length!==Te.length||ie[0]!==n.COLOR_ATTACHMENT0){for(let Ee=0,Xe=Te.length;Ee<Xe;Ee++)ie[Ee]=n.COLOR_ATTACHMENT0+Ee;ie.length=Te.length,le=!0}}else ie[0]!==n.BACK&&(ie[0]=n.BACK,le=!0);le&&n.drawBuffers(ie)}function ke(F){return _!==F?(n.useProgram(F),_=F,!0):!1}const k={[co]:n.FUNC_ADD,[LS]:n.FUNC_SUBTRACT,[IS]:n.FUNC_REVERSE_SUBTRACT};k[OS]=n.MIN,k[US]=n.MAX;const L={[BS]:n.ZERO,[NS]:n.ONE,[FS]:n.SRC_COLOR,[vd]:n.SRC_ALPHA,[WS]:n.SRC_ALPHA_SATURATE,[GS]:n.DST_COLOR,[HS]:n.DST_ALPHA,[zS]:n.ONE_MINUS_SRC_COLOR,[yd]:n.ONE_MINUS_SRC_ALPHA,[$S]:n.ONE_MINUS_DST_COLOR,[VS]:n.ONE_MINUS_DST_ALPHA,[XS]:n.CONSTANT_COLOR,[jS]:n.ONE_MINUS_CONSTANT_COLOR,[YS]:n.CONSTANT_ALPHA,[qS]:n.ONE_MINUS_CONSTANT_ALPHA};function w(F,we,ie,le,Te,Ee,Xe,Dt,Qt,ft){if(F===Di){m===!0&&(se(n.BLEND),m=!1);return}if(m===!1&&(N(n.BLEND),m=!0),F!==DS){if(F!==g||ft!==y){if((p!==co||b!==co)&&(n.blendEquation(n.FUNC_ADD),p=co,b=co),ft)switch(F){case bs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case jp:n.blendFunc(n.ONE,n.ONE);break;case Yp:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case qp:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case bs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case jp:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Yp:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case qp:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}x=null,v=null,E=null,R=null,A.set(0,0,0),P=0,g=F,y=ft}return}Te=Te||we,Ee=Ee||ie,Xe=Xe||le,(we!==p||Te!==b)&&(n.blendEquationSeparate(k[we],k[Te]),p=we,b=Te),(ie!==x||le!==v||Ee!==E||Xe!==R)&&(n.blendFuncSeparate(L[ie],L[le],L[Ee],L[Xe]),x=ie,v=le,E=Ee,R=Xe),(Dt.equals(A)===!1||Qt!==P)&&(n.blendColor(Dt.r,Dt.g,Dt.b,Qt),A.copy(Dt),P=Qt),g=F,y=!1}function re(F,we){F.side===wr?se(n.CULL_FACE):N(n.CULL_FACE);let ie=F.side===yn;we&&(ie=!ie),K(ie),F.blending===bs&&F.transparent===!1?w(Di):w(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),s.setFunc(F.depthFunc),s.setTest(F.depthTest),s.setMask(F.depthWrite),o.setMask(F.colorWrite);const le=F.stencilWrite;a.setTest(le),le&&(a.setMask(F.stencilWriteMask),a.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),a.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),ae(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?N(n.SAMPLE_ALPHA_TO_COVERAGE):se(n.SAMPLE_ALPHA_TO_COVERAGE)}function K(F){M!==F&&(F?n.frontFace(n.CW):n.frontFace(n.CCW),M=F)}function q(F){F!==RS?(N(n.CULL_FACE),F!==D&&(F===Xp?n.cullFace(n.BACK):F===PS?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):se(n.CULL_FACE),D=F}function ne(F){F!==O&&(V&&n.lineWidth(F),O=F)}function ae(F,we,ie){F?(N(n.POLYGON_OFFSET_FILL),(U!==we||Y!==ie)&&(n.polygonOffset(we,ie),U=we,Y=ie)):se(n.POLYGON_OFFSET_FILL)}function ee(F){F?N(n.SCISSOR_TEST):se(n.SCISSOR_TEST)}function C(F){F===void 0&&(F=n.TEXTURE0+J-1),fe!==F&&(n.activeTexture(F),fe=F)}function S(F,we,ie){ie===void 0&&(fe===null?ie=n.TEXTURE0+J-1:ie=fe);let le=he[ie];le===void 0&&(le={type:void 0,texture:void 0},he[ie]=le),(le.type!==F||le.texture!==we)&&(fe!==ie&&(n.activeTexture(ie),fe=ie),n.bindTexture(F,we||ve[F]),le.type=F,le.texture=we)}function I(){const F=he[fe];F!==void 0&&F.type!==void 0&&(n.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function B(){try{n.compressedTexImage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function X(){try{n.compressedTexImage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function W(){try{n.texSubImage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function me(){try{n.texSubImage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ce(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function be(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ue(){try{n.texStorage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function pe(){try{n.texStorage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Se(){try{n.texImage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function De(){try{n.texImage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Be(F){Fe.equals(F)===!1&&(n.scissor(F.x,F.y,F.z,F.w),Fe.copy(F))}function ye(F){Q.equals(F)===!1&&(n.viewport(F.x,F.y,F.z,F.w),Q.copy(F))}function ze(F,we){let ie=c.get(we);ie===void 0&&(ie=new WeakMap,c.set(we,ie));let le=ie.get(F);le===void 0&&(le=n.getUniformBlockIndex(we,F.name),ie.set(F,le))}function We(F,we){const le=c.get(we).get(F);l.get(we)!==le&&(n.uniformBlockBinding(we,le,F.__bindingPointIndex),l.set(we,le))}function yt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),s.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},fe=null,he={},d={},f=new WeakMap,h=[],_=null,m=!1,g=null,p=null,x=null,v=null,b=null,E=null,R=null,A=new tt(0,0,0),P=0,y=!1,M=null,D=null,O=null,U=null,Y=null,Fe.set(0,0,n.canvas.width,n.canvas.height),Q.set(0,0,n.canvas.width,n.canvas.height),o.reset(),s.reset(),a.reset()}return{buffers:{color:o,depth:s,stencil:a},enable:N,disable:se,bindFramebuffer:oe,drawBuffers:ue,useProgram:ke,setBlending:w,setMaterial:re,setFlipSided:K,setCullFace:q,setLineWidth:ne,setPolygonOffset:ae,setScissorTest:ee,activeTexture:C,bindTexture:S,unbindTexture:I,compressedTexImage2D:B,compressedTexImage3D:X,texImage2D:Se,texImage3D:De,updateUBOMapping:ze,uniformBlockBinding:We,texStorage2D:Ue,texStorage3D:pe,texSubImage2D:W,texSubImage3D:me,compressedTexSubImage2D:ce,compressedTexSubImage3D:be,scissor:Be,viewport:ye,reset:yt}}function Y2(n,e,t,r,i,o,s){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $e,u=new WeakMap;let d;const f=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(C,S){return h?new OffscreenCanvas(C,S):Ba("canvas")}function m(C,S,I){let B=1;const X=ee(C);if((X.width>I||X.height>I)&&(B=I/Math.max(X.width,X.height)),B<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const W=Math.floor(B*X.width),me=Math.floor(B*X.height);d===void 0&&(d=_(W,me));const ce=S?_(W,me):d;return ce.width=W,ce.height=me,ce.getContext("2d").drawImage(C,0,0,W,me),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+X.width+"x"+X.height+") to ("+W+"x"+me+")."),ce}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+X.width+"x"+X.height+")."),C;return C}function g(C){return C.generateMipmaps}function p(C){n.generateMipmap(C)}function x(C){return C.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?n.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function v(C,S,I,B,X=!1){if(C!==null){if(n[C]!==void 0)return n[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let W=S;if(S===n.RED&&(I===n.FLOAT&&(W=n.R32F),I===n.HALF_FLOAT&&(W=n.R16F),I===n.UNSIGNED_BYTE&&(W=n.R8)),S===n.RED_INTEGER&&(I===n.UNSIGNED_BYTE&&(W=n.R8UI),I===n.UNSIGNED_SHORT&&(W=n.R16UI),I===n.UNSIGNED_INT&&(W=n.R32UI),I===n.BYTE&&(W=n.R8I),I===n.SHORT&&(W=n.R16I),I===n.INT&&(W=n.R32I)),S===n.RG&&(I===n.FLOAT&&(W=n.RG32F),I===n.HALF_FLOAT&&(W=n.RG16F),I===n.UNSIGNED_BYTE&&(W=n.RG8)),S===n.RG_INTEGER&&(I===n.UNSIGNED_BYTE&&(W=n.RG8UI),I===n.UNSIGNED_SHORT&&(W=n.RG16UI),I===n.UNSIGNED_INT&&(W=n.RG32UI),I===n.BYTE&&(W=n.RG8I),I===n.SHORT&&(W=n.RG16I),I===n.INT&&(W=n.RG32I)),S===n.RGB_INTEGER&&(I===n.UNSIGNED_BYTE&&(W=n.RGB8UI),I===n.UNSIGNED_SHORT&&(W=n.RGB16UI),I===n.UNSIGNED_INT&&(W=n.RGB32UI),I===n.BYTE&&(W=n.RGB8I),I===n.SHORT&&(W=n.RGB16I),I===n.INT&&(W=n.RGB32I)),S===n.RGBA_INTEGER&&(I===n.UNSIGNED_BYTE&&(W=n.RGBA8UI),I===n.UNSIGNED_SHORT&&(W=n.RGBA16UI),I===n.UNSIGNED_INT&&(W=n.RGBA32UI),I===n.BYTE&&(W=n.RGBA8I),I===n.SHORT&&(W=n.RGBA16I),I===n.INT&&(W=n.RGBA32I)),S===n.RGB&&I===n.UNSIGNED_INT_5_9_9_9_REV&&(W=n.RGB9_E5),S===n.RGBA){const me=X?mc:ot.getTransfer(B);I===n.FLOAT&&(W=n.RGBA32F),I===n.HALF_FLOAT&&(W=n.RGBA16F),I===n.UNSIGNED_BYTE&&(W=me===ht?n.SRGB8_ALPHA8:n.RGBA8),I===n.UNSIGNED_SHORT_4_4_4_4&&(W=n.RGBA4),I===n.UNSIGNED_SHORT_5_5_5_1&&(W=n.RGB5_A1)}return(W===n.R16F||W===n.R32F||W===n.RG16F||W===n.RG32F||W===n.RGBA16F||W===n.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function b(C,S){let I;return C?S===null||S===wo||S===ks?I=n.DEPTH24_STENCIL8:S===Qr?I=n.DEPTH32F_STENCIL8:S===Oa&&(I=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===wo||S===ks?I=n.DEPTH_COMPONENT24:S===Qr?I=n.DEPTH_COMPONENT32F:S===Oa&&(I=n.DEPTH_COMPONENT16),I}function E(C,S){return g(C)===!0||C.isFramebufferTexture&&C.minFilter!==mr&&C.minFilter!==Er?Math.log2(Math.max(S.width,S.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?S.mipmaps.length:1}function R(C){const S=C.target;S.removeEventListener("dispose",R),P(S),S.isVideoTexture&&u.delete(S)}function A(C){const S=C.target;S.removeEventListener("dispose",A),M(S)}function P(C){const S=r.get(C);if(S.__webglInit===void 0)return;const I=C.source,B=f.get(I);if(B){const X=B[S.__cacheKey];X.usedTimes--,X.usedTimes===0&&y(C),Object.keys(B).length===0&&f.delete(I)}r.remove(C)}function y(C){const S=r.get(C);n.deleteTexture(S.__webglTexture);const I=C.source,B=f.get(I);delete B[S.__cacheKey],s.memory.textures--}function M(C){const S=r.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),r.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let B=0;B<6;B++){if(Array.isArray(S.__webglFramebuffer[B]))for(let X=0;X<S.__webglFramebuffer[B].length;X++)n.deleteFramebuffer(S.__webglFramebuffer[B][X]);else n.deleteFramebuffer(S.__webglFramebuffer[B]);S.__webglDepthbuffer&&n.deleteRenderbuffer(S.__webglDepthbuffer[B])}else{if(Array.isArray(S.__webglFramebuffer))for(let B=0;B<S.__webglFramebuffer.length;B++)n.deleteFramebuffer(S.__webglFramebuffer[B]);else n.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&n.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&n.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let B=0;B<S.__webglColorRenderbuffer.length;B++)S.__webglColorRenderbuffer[B]&&n.deleteRenderbuffer(S.__webglColorRenderbuffer[B]);S.__webglDepthRenderbuffer&&n.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const I=C.textures;for(let B=0,X=I.length;B<X;B++){const W=r.get(I[B]);W.__webglTexture&&(n.deleteTexture(W.__webglTexture),s.memory.textures--),r.remove(I[B])}r.remove(C)}let D=0;function O(){D=0}function U(){const C=D;return C>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+i.maxTextures),D+=1,C}function Y(C){const S=[];return S.push(C.wrapS),S.push(C.wrapT),S.push(C.wrapR||0),S.push(C.magFilter),S.push(C.minFilter),S.push(C.anisotropy),S.push(C.internalFormat),S.push(C.format),S.push(C.type),S.push(C.generateMipmaps),S.push(C.premultiplyAlpha),S.push(C.flipY),S.push(C.unpackAlignment),S.push(C.colorSpace),S.join()}function J(C,S){const I=r.get(C);if(C.isVideoTexture&&ne(C),C.isRenderTargetTexture===!1&&C.version>0&&I.__version!==C.version){const B=C.image;if(B===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(B.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Q(I,C,S);return}}t.bindTexture(n.TEXTURE_2D,I.__webglTexture,n.TEXTURE0+S)}function V(C,S){const I=r.get(C);if(C.version>0&&I.__version!==C.version){Q(I,C,S);return}t.bindTexture(n.TEXTURE_2D_ARRAY,I.__webglTexture,n.TEXTURE0+S)}function G(C,S){const I=r.get(C);if(C.version>0&&I.__version!==C.version){Q(I,C,S);return}t.bindTexture(n.TEXTURE_3D,I.__webglTexture,n.TEXTURE0+S)}function z(C,S){const I=r.get(C);if(C.version>0&&I.__version!==C.version){de(I,C,S);return}t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+S)}const fe={[Ia]:n.REPEAT,[fo]:n.CLAMP_TO_EDGE,[Rd]:n.MIRRORED_REPEAT},he={[mr]:n.NEAREST,[oM]:n.NEAREST_MIPMAP_NEAREST,[vl]:n.NEAREST_MIPMAP_LINEAR,[Er]:n.LINEAR,[gu]:n.LINEAR_MIPMAP_NEAREST,[ho]:n.LINEAR_MIPMAP_LINEAR},_e={[cM]:n.NEVER,[mM]:n.ALWAYS,[uM]:n.LESS,[G_]:n.LEQUAL,[dM]:n.EQUAL,[pM]:n.GEQUAL,[fM]:n.GREATER,[hM]:n.NOTEQUAL};function Me(C,S){if(S.type===Qr&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===Er||S.magFilter===gu||S.magFilter===vl||S.magFilter===ho||S.minFilter===Er||S.minFilter===gu||S.minFilter===vl||S.minFilter===ho)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(C,n.TEXTURE_WRAP_S,fe[S.wrapS]),n.texParameteri(C,n.TEXTURE_WRAP_T,fe[S.wrapT]),(C===n.TEXTURE_3D||C===n.TEXTURE_2D_ARRAY)&&n.texParameteri(C,n.TEXTURE_WRAP_R,fe[S.wrapR]),n.texParameteri(C,n.TEXTURE_MAG_FILTER,he[S.magFilter]),n.texParameteri(C,n.TEXTURE_MIN_FILTER,he[S.minFilter]),S.compareFunction&&(n.texParameteri(C,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(C,n.TEXTURE_COMPARE_FUNC,_e[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===mr||S.minFilter!==vl&&S.minFilter!==ho||S.type===Qr&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||r.get(S).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");n.texParameterf(C,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,i.getMaxAnisotropy())),r.get(S).__currentAnisotropy=S.anisotropy}}}function Fe(C,S){let I=!1;C.__webglInit===void 0&&(C.__webglInit=!0,S.addEventListener("dispose",R));const B=S.source;let X=f.get(B);X===void 0&&(X={},f.set(B,X));const W=Y(S);if(W!==C.__cacheKey){X[W]===void 0&&(X[W]={texture:n.createTexture(),usedTimes:0},s.memory.textures++,I=!0),X[W].usedTimes++;const me=X[C.__cacheKey];me!==void 0&&(X[C.__cacheKey].usedTimes--,me.usedTimes===0&&y(S)),C.__cacheKey=W,C.__webglTexture=X[W].texture}return I}function Q(C,S,I){let B=n.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(B=n.TEXTURE_2D_ARRAY),S.isData3DTexture&&(B=n.TEXTURE_3D);const X=Fe(C,S),W=S.source;t.bindTexture(B,C.__webglTexture,n.TEXTURE0+I);const me=r.get(W);if(W.version!==me.__version||X===!0){t.activeTexture(n.TEXTURE0+I);const ce=ot.getPrimaries(ot.workingColorSpace),be=S.colorSpace===Ei?null:ot.getPrimaries(S.colorSpace),Ue=S.colorSpace===Ei||ce===be?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ue);let pe=m(S.image,!1,i.maxTextureSize);pe=ae(S,pe);const Se=o.convert(S.format,S.colorSpace),De=o.convert(S.type);let Be=v(S.internalFormat,Se,De,S.colorSpace,S.isVideoTexture);Me(B,S);let ye;const ze=S.mipmaps,We=S.isVideoTexture!==!0,yt=me.__version===void 0||X===!0,F=W.dataReady,we=E(S,pe);if(S.isDepthTexture)Be=b(S.format===Ds,S.type),yt&&(We?t.texStorage2D(n.TEXTURE_2D,1,Be,pe.width,pe.height):t.texImage2D(n.TEXTURE_2D,0,Be,pe.width,pe.height,0,Se,De,null));else if(S.isDataTexture)if(ze.length>0){We&&yt&&t.texStorage2D(n.TEXTURE_2D,we,Be,ze[0].width,ze[0].height);for(let ie=0,le=ze.length;ie<le;ie++)ye=ze[ie],We?F&&t.texSubImage2D(n.TEXTURE_2D,ie,0,0,ye.width,ye.height,Se,De,ye.data):t.texImage2D(n.TEXTURE_2D,ie,Be,ye.width,ye.height,0,Se,De,ye.data);S.generateMipmaps=!1}else We?(yt&&t.texStorage2D(n.TEXTURE_2D,we,Be,pe.width,pe.height),F&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,pe.width,pe.height,Se,De,pe.data)):t.texImage2D(n.TEXTURE_2D,0,Be,pe.width,pe.height,0,Se,De,pe.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){We&&yt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,we,Be,ze[0].width,ze[0].height,pe.depth);for(let ie=0,le=ze.length;ie<le;ie++)if(ye=ze[ie],S.format!==hr)if(Se!==null)if(We){if(F)if(S.layerUpdates.size>0){const Te=Em(ye.width,ye.height,S.format,S.type);for(const Ee of S.layerUpdates){const Xe=ye.data.subarray(Ee*Te/ye.data.BYTES_PER_ELEMENT,(Ee+1)*Te/ye.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ie,0,0,Ee,ye.width,ye.height,1,Se,Xe)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ie,0,0,0,ye.width,ye.height,pe.depth,Se,ye.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ie,Be,ye.width,ye.height,pe.depth,0,ye.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else We?F&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ie,0,0,0,ye.width,ye.height,pe.depth,Se,De,ye.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ie,Be,ye.width,ye.height,pe.depth,0,Se,De,ye.data)}else{We&&yt&&t.texStorage2D(n.TEXTURE_2D,we,Be,ze[0].width,ze[0].height);for(let ie=0,le=ze.length;ie<le;ie++)ye=ze[ie],S.format!==hr?Se!==null?We?F&&t.compressedTexSubImage2D(n.TEXTURE_2D,ie,0,0,ye.width,ye.height,Se,ye.data):t.compressedTexImage2D(n.TEXTURE_2D,ie,Be,ye.width,ye.height,0,ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):We?F&&t.texSubImage2D(n.TEXTURE_2D,ie,0,0,ye.width,ye.height,Se,De,ye.data):t.texImage2D(n.TEXTURE_2D,ie,Be,ye.width,ye.height,0,Se,De,ye.data)}else if(S.isDataArrayTexture)if(We){if(yt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,we,Be,pe.width,pe.height,pe.depth),F)if(S.layerUpdates.size>0){const ie=Em(pe.width,pe.height,S.format,S.type);for(const le of S.layerUpdates){const Te=pe.data.subarray(le*ie/pe.data.BYTES_PER_ELEMENT,(le+1)*ie/pe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,le,pe.width,pe.height,1,Se,De,Te)}S.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,pe.width,pe.height,pe.depth,Se,De,pe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Be,pe.width,pe.height,pe.depth,0,Se,De,pe.data);else if(S.isData3DTexture)We?(yt&&t.texStorage3D(n.TEXTURE_3D,we,Be,pe.width,pe.height,pe.depth),F&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,pe.width,pe.height,pe.depth,Se,De,pe.data)):t.texImage3D(n.TEXTURE_3D,0,Be,pe.width,pe.height,pe.depth,0,Se,De,pe.data);else if(S.isFramebufferTexture){if(yt)if(We)t.texStorage2D(n.TEXTURE_2D,we,Be,pe.width,pe.height);else{let ie=pe.width,le=pe.height;for(let Te=0;Te<we;Te++)t.texImage2D(n.TEXTURE_2D,Te,Be,ie,le,0,Se,De,null),ie>>=1,le>>=1}}else if(ze.length>0){if(We&&yt){const ie=ee(ze[0]);t.texStorage2D(n.TEXTURE_2D,we,Be,ie.width,ie.height)}for(let ie=0,le=ze.length;ie<le;ie++)ye=ze[ie],We?F&&t.texSubImage2D(n.TEXTURE_2D,ie,0,0,Se,De,ye):t.texImage2D(n.TEXTURE_2D,ie,Be,Se,De,ye);S.generateMipmaps=!1}else if(We){if(yt){const ie=ee(pe);t.texStorage2D(n.TEXTURE_2D,we,Be,ie.width,ie.height)}F&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Se,De,pe)}else t.texImage2D(n.TEXTURE_2D,0,Be,Se,De,pe);g(S)&&p(B),me.__version=W.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function de(C,S,I){if(S.image.length!==6)return;const B=Fe(C,S),X=S.source;t.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+I);const W=r.get(X);if(X.version!==W.__version||B===!0){t.activeTexture(n.TEXTURE0+I);const me=ot.getPrimaries(ot.workingColorSpace),ce=S.colorSpace===Ei?null:ot.getPrimaries(S.colorSpace),be=S.colorSpace===Ei||me===ce?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);const Ue=S.isCompressedTexture||S.image[0].isCompressedTexture,pe=S.image[0]&&S.image[0].isDataTexture,Se=[];for(let le=0;le<6;le++)!Ue&&!pe?Se[le]=m(S.image[le],!0,i.maxCubemapSize):Se[le]=pe?S.image[le].image:S.image[le],Se[le]=ae(S,Se[le]);const De=Se[0],Be=o.convert(S.format,S.colorSpace),ye=o.convert(S.type),ze=v(S.internalFormat,Be,ye,S.colorSpace),We=S.isVideoTexture!==!0,yt=W.__version===void 0||B===!0,F=X.dataReady;let we=E(S,De);Me(n.TEXTURE_CUBE_MAP,S);let ie;if(Ue){We&&yt&&t.texStorage2D(n.TEXTURE_CUBE_MAP,we,ze,De.width,De.height);for(let le=0;le<6;le++){ie=Se[le].mipmaps;for(let Te=0;Te<ie.length;Te++){const Ee=ie[Te];S.format!==hr?Be!==null?We?F&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Te,0,0,Ee.width,Ee.height,Be,Ee.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Te,ze,Ee.width,Ee.height,0,Ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):We?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Te,0,0,Ee.width,Ee.height,Be,ye,Ee.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Te,ze,Ee.width,Ee.height,0,Be,ye,Ee.data)}}}else{if(ie=S.mipmaps,We&&yt){ie.length>0&&we++;const le=ee(Se[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,we,ze,le.width,le.height)}for(let le=0;le<6;le++)if(pe){We?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,Se[le].width,Se[le].height,Be,ye,Se[le].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,ze,Se[le].width,Se[le].height,0,Be,ye,Se[le].data);for(let Te=0;Te<ie.length;Te++){const Xe=ie[Te].image[le].image;We?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Te+1,0,0,Xe.width,Xe.height,Be,ye,Xe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Te+1,ze,Xe.width,Xe.height,0,Be,ye,Xe.data)}}else{We?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,Be,ye,Se[le]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,ze,Be,ye,Se[le]);for(let Te=0;Te<ie.length;Te++){const Ee=ie[Te];We?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Te+1,0,0,Be,ye,Ee.image[le]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Te+1,ze,Be,ye,Ee.image[le])}}}g(S)&&p(n.TEXTURE_CUBE_MAP),W.__version=X.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function ve(C,S,I,B,X,W){const me=o.convert(I.format,I.colorSpace),ce=o.convert(I.type),be=v(I.internalFormat,me,ce,I.colorSpace),Ue=r.get(S),pe=r.get(I);if(pe.__renderTarget=S,!Ue.__hasExternalTextures){const Se=Math.max(1,S.width>>W),De=Math.max(1,S.height>>W);X===n.TEXTURE_3D||X===n.TEXTURE_2D_ARRAY?t.texImage3D(X,W,be,Se,De,S.depth,0,me,ce,null):t.texImage2D(X,W,be,Se,De,0,me,ce,null)}t.bindFramebuffer(n.FRAMEBUFFER,C),q(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,B,X,pe.__webglTexture,0,K(S)):(X===n.TEXTURE_2D||X>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&X<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,B,X,pe.__webglTexture,W),t.bindFramebuffer(n.FRAMEBUFFER,null)}function N(C,S,I){if(n.bindRenderbuffer(n.RENDERBUFFER,C),S.depthBuffer){const B=S.depthTexture,X=B&&B.isDepthTexture?B.type:null,W=b(S.stencilBuffer,X),me=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ce=K(S);q(S)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ce,W,S.width,S.height):I?n.renderbufferStorageMultisample(n.RENDERBUFFER,ce,W,S.width,S.height):n.renderbufferStorage(n.RENDERBUFFER,W,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,me,n.RENDERBUFFER,C)}else{const B=S.textures;for(let X=0;X<B.length;X++){const W=B[X],me=o.convert(W.format,W.colorSpace),ce=o.convert(W.type),be=v(W.internalFormat,me,ce,W.colorSpace),Ue=K(S);I&&q(S)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ue,be,S.width,S.height):q(S)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ue,be,S.width,S.height):n.renderbufferStorage(n.RENDERBUFFER,be,S.width,S.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function se(C,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,C),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const B=r.get(S.depthTexture);B.__renderTarget=S,(!B.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),J(S.depthTexture,0);const X=B.__webglTexture,W=K(S);if(S.depthTexture.format===vs)q(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,X,0,W):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,X,0);else if(S.depthTexture.format===Ds)q(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,X,0,W):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,X,0);else throw new Error("Unknown depthTexture format")}function oe(C){const S=r.get(C),I=C.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==C.depthTexture){const B=C.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),B){const X=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,B.removeEventListener("dispose",X)};B.addEventListener("dispose",X),S.__depthDisposeCallback=X}S.__boundDepthTexture=B}if(C.depthTexture&&!S.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");se(S.__webglFramebuffer,C)}else if(I){S.__webglDepthbuffer=[];for(let B=0;B<6;B++)if(t.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer[B]),S.__webglDepthbuffer[B]===void 0)S.__webglDepthbuffer[B]=n.createRenderbuffer(),N(S.__webglDepthbuffer[B],C,!1);else{const X=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,W=S.__webglDepthbuffer[B];n.bindRenderbuffer(n.RENDERBUFFER,W),n.framebufferRenderbuffer(n.FRAMEBUFFER,X,n.RENDERBUFFER,W)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=n.createRenderbuffer(),N(S.__webglDepthbuffer,C,!1);else{const B=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,X=S.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,X),n.framebufferRenderbuffer(n.FRAMEBUFFER,B,n.RENDERBUFFER,X)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function ue(C,S,I){const B=r.get(C);S!==void 0&&ve(B.__webglFramebuffer,C,C.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),I!==void 0&&oe(C)}function ke(C){const S=C.texture,I=r.get(C),B=r.get(S);C.addEventListener("dispose",A);const X=C.textures,W=C.isWebGLCubeRenderTarget===!0,me=X.length>1;if(me||(B.__webglTexture===void 0&&(B.__webglTexture=n.createTexture()),B.__version=S.version,s.memory.textures++),W){I.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(S.mipmaps&&S.mipmaps.length>0){I.__webglFramebuffer[ce]=[];for(let be=0;be<S.mipmaps.length;be++)I.__webglFramebuffer[ce][be]=n.createFramebuffer()}else I.__webglFramebuffer[ce]=n.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){I.__webglFramebuffer=[];for(let ce=0;ce<S.mipmaps.length;ce++)I.__webglFramebuffer[ce]=n.createFramebuffer()}else I.__webglFramebuffer=n.createFramebuffer();if(me)for(let ce=0,be=X.length;ce<be;ce++){const Ue=r.get(X[ce]);Ue.__webglTexture===void 0&&(Ue.__webglTexture=n.createTexture(),s.memory.textures++)}if(C.samples>0&&q(C)===!1){I.__webglMultisampledFramebuffer=n.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ce=0;ce<X.length;ce++){const be=X[ce];I.__webglColorRenderbuffer[ce]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,I.__webglColorRenderbuffer[ce]);const Ue=o.convert(be.format,be.colorSpace),pe=o.convert(be.type),Se=v(be.internalFormat,Ue,pe,be.colorSpace,C.isXRRenderTarget===!0),De=K(C);n.renderbufferStorageMultisample(n.RENDERBUFFER,De,Se,C.width,C.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ce,n.RENDERBUFFER,I.__webglColorRenderbuffer[ce])}n.bindRenderbuffer(n.RENDERBUFFER,null),C.depthBuffer&&(I.__webglDepthRenderbuffer=n.createRenderbuffer(),N(I.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(W){t.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture),Me(n.TEXTURE_CUBE_MAP,S);for(let ce=0;ce<6;ce++)if(S.mipmaps&&S.mipmaps.length>0)for(let be=0;be<S.mipmaps.length;be++)ve(I.__webglFramebuffer[ce][be],C,S,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,be);else ve(I.__webglFramebuffer[ce],C,S,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);g(S)&&p(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(me){for(let ce=0,be=X.length;ce<be;ce++){const Ue=X[ce],pe=r.get(Ue);t.bindTexture(n.TEXTURE_2D,pe.__webglTexture),Me(n.TEXTURE_2D,Ue),ve(I.__webglFramebuffer,C,Ue,n.COLOR_ATTACHMENT0+ce,n.TEXTURE_2D,0),g(Ue)&&p(n.TEXTURE_2D)}t.unbindTexture()}else{let ce=n.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ce=C.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ce,B.__webglTexture),Me(ce,S),S.mipmaps&&S.mipmaps.length>0)for(let be=0;be<S.mipmaps.length;be++)ve(I.__webglFramebuffer[be],C,S,n.COLOR_ATTACHMENT0,ce,be);else ve(I.__webglFramebuffer,C,S,n.COLOR_ATTACHMENT0,ce,0);g(S)&&p(ce),t.unbindTexture()}C.depthBuffer&&oe(C)}function k(C){const S=C.textures;for(let I=0,B=S.length;I<B;I++){const X=S[I];if(g(X)){const W=x(C),me=r.get(X).__webglTexture;t.bindTexture(W,me),p(W),t.unbindTexture()}}}const L=[],w=[];function re(C){if(C.samples>0){if(q(C)===!1){const S=C.textures,I=C.width,B=C.height;let X=n.COLOR_BUFFER_BIT;const W=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,me=r.get(C),ce=S.length>1;if(ce)for(let be=0;be<S.length;be++)t.bindFramebuffer(n.FRAMEBUFFER,me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,me.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,me.__webglFramebuffer);for(let be=0;be<S.length;be++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(X|=n.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(X|=n.STENCIL_BUFFER_BIT)),ce){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,me.__webglColorRenderbuffer[be]);const Ue=r.get(S[be]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ue,0)}n.blitFramebuffer(0,0,I,B,0,0,I,B,X,n.NEAREST),l===!0&&(L.length=0,w.length=0,L.push(n.COLOR_ATTACHMENT0+be),C.depthBuffer&&C.resolveDepthBuffer===!1&&(L.push(W),w.push(W),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,w)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,L))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ce)for(let be=0;be<S.length;be++){t.bindFramebuffer(n.FRAMEBUFFER,me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.RENDERBUFFER,me.__webglColorRenderbuffer[be]);const Ue=r.get(S[be]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.TEXTURE_2D,Ue,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,me.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const S=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[S])}}}function K(C){return Math.min(i.maxSamples,C.samples)}function q(C){const S=r.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function ne(C){const S=s.render.frame;u.get(C)!==S&&(u.set(C,S),C.update())}function ae(C,S){const I=C.colorSpace,B=C.format,X=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||I!==Ls&&I!==Ei&&(ot.getTransfer(I)===ht?(B!==hr||X!==ii)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),S}function ee(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=U,this.resetTextureUnits=O,this.setTexture2D=J,this.setTexture2DArray=V,this.setTexture3D=G,this.setTextureCube=z,this.rebindTextures=ue,this.setupRenderTarget=ke,this.updateRenderTargetMipmap=k,this.updateMultisampleRenderTarget=re,this.setupDepthRenderbuffer=oe,this.setupFrameBufferTexture=ve,this.useMultisampledRTT=q}function q2(n,e){function t(r,i=Ei){let o;const s=ot.getTransfer(i);if(r===ii)return n.UNSIGNED_BYTE;if(r===eh)return n.UNSIGNED_SHORT_4_4_4_4;if(r===th)return n.UNSIGNED_SHORT_5_5_5_1;if(r===I_)return n.UNSIGNED_INT_5_9_9_9_REV;if(r===D_)return n.BYTE;if(r===L_)return n.SHORT;if(r===Oa)return n.UNSIGNED_SHORT;if(r===Qf)return n.INT;if(r===wo)return n.UNSIGNED_INT;if(r===Qr)return n.FLOAT;if(r===sl)return n.HALF_FLOAT;if(r===O_)return n.ALPHA;if(r===U_)return n.RGB;if(r===hr)return n.RGBA;if(r===B_)return n.LUMINANCE;if(r===N_)return n.LUMINANCE_ALPHA;if(r===vs)return n.DEPTH_COMPONENT;if(r===Ds)return n.DEPTH_STENCIL;if(r===F_)return n.RED;if(r===nh)return n.RED_INTEGER;if(r===z_)return n.RG;if(r===rh)return n.RG_INTEGER;if(r===ih)return n.RGBA_INTEGER;if(r===Zl||r===Jl||r===Ql||r===ec)if(s===ht)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(r===Zl)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Jl)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Ql)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===ec)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(r===Zl)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Jl)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Ql)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===ec)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Pd||r===kd||r===Dd||r===Ld)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(r===Pd)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===kd)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Dd)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Ld)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Id||r===Od||r===Ud)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(r===Id||r===Od)return s===ht?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(r===Ud)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Bd||r===Nd||r===Fd||r===zd||r===Hd||r===Vd||r===Gd||r===$d||r===Wd||r===Xd||r===jd||r===Yd||r===qd||r===Kd)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(r===Bd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Nd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Fd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===zd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Hd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Vd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Gd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===$d)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Wd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Xd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===jd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===Yd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===qd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===Kd)return s===ht?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===tc||r===Zd||r===Jd)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(r===tc)return s===ht?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===Zd)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===Jd)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===H_||r===Qd||r===ef||r===tf)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(r===tc)return o.COMPRESSED_RED_RGTC1_EXT;if(r===Qd)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===ef)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===tf)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===ks?n.UNSIGNED_INT_24_8:n[r]!==void 0?n[r]:null}return{convert:t}}const K2={type:"move"};class Wu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ss,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ss,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new j,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new j),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ss,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new j,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new j),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const r of e.hand.values())this._getHandJoint(t,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,r){let i=null,o=null,s=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){s=!0;for(const m of e.hand.values()){const g=t.getJointPose(m,r),p=this._getHandJoint(c,m);g!==null&&(p.matrix.fromArray(g.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=g.radius),p.visible=g!==null}const u=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],f=u.position.distanceTo(d.position),h=.02,_=.005;c.inputState.pinching&&f>h+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=h-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(o=t.getPose(e.gripSpace,r),o!==null&&(l.matrix.fromArray(o.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,o.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(o.linearVelocity)):l.hasLinearVelocity=!1,o.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(o.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(i=t.getPose(e.targetRaySpace,r),i===null&&o!==null&&(i=o),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(K2)))}return a!==null&&(a.visible=i!==null),l!==null&&(l.visible=o!==null),c!==null&&(c.visible=s!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const r=new ss;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[t.jointName]=r,e.add(r)}return e.joints[t.jointName]}}const Z2=`
void main() {
